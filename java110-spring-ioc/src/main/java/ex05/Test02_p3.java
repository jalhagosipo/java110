...
public class Test02_p3 {
    ...
    static class Member{ // 안적어도 기본이 extends Object임
        String name;
        int age;
        ...
        public boolean equals(Object obj) {
            ...
            if(!(obj.getClass() == Member.class)) // !(obj instanceof Member) 랑같음
                return false;
        ...
        @Override
        public int hashCode() {
            return this.toString().hashCode(); //같은 문자열은 해쉬코드가 같으니까
        }
    }
    ...
    public static void main(String[] args) {
        ...
        //
        // 주의!
        // => Object에서 상속 받은 hashCode()는 각 인스턴스 마다 다른 
        //    고유의 hash 값을 리턴한다.
        //    즉 equasl()의 리턴 값이 true라도 hash 값이 다르다는 것이다.
        //    
        // 해결책
